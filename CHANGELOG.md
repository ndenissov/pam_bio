...
* fix(daemon): add 3-second grace period for mDNS/TCP connection during auth to prevent SDDM fallback on wake
...
* feat: update Developer section in UI and add missing Chinese strings
* chore: resolve remaining Kotlin and Go lint issues
